...
## Asked for, not drawn yet

Honesty table: these names have designed answers, and the engine refuses
toward them with a direction rather than drawing something else.
...
| Choropleth / geographic map | needs the `map` space, named in the kernel, not yet drawn |
